...
public class UsableArea extends QueryReplyField {
    ...
    private static class AddressingMode {
        ...
        private static final AddressingMode ADDRESSING_12_14_BIT =
                new AddressingMode(1, "12/14 bit");
        private static final AddressingMode ADDRESSING_14_14_16_BIT =
                new AddressingMode(3, "12/14/16 bit");
        private static final AddressingMode[] MODES = {
            new AddressingMode(0, RESERVED),
            ADDRESSING_12_14_BIT,
            new AddressingMode(1, RESERVED),
            ADDRESSING_14_14_16_BIT
        };
    ...
    public String toString() {
        return super.toString()
                ...
                + String.format(
                        "%n  units      : %d - %s", measurementUnit.id, measurementUnit.name)
                + String.format(
                        "%n  x ratio    : %d / %d",
                        xPointsDistanceNumerator, xPointsDistanceDenominator)
                + String.format(
                        "%n  y ratio    : %d / %d",
                        yPointsDistanceNumerator, yPointsDistanceDenominator)
