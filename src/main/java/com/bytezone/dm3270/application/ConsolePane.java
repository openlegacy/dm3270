...
public class ConsolePane
    ...
    private void sendAID(Command command) {
        ...
        if (telnetState.does3270Extended()) {
            ...
            TN3270ExtendedCommand extendedCommand =
                    new TN3270ExtendedCommand(header, command, telnetState, screen.getCharset());
    ...
    public void connect() {
        ...
        terminalServer =
                new TerminalServer(
                        server.getURL(), server.getPort(), socketFactory, telnetListener);
