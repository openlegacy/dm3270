...
public class ScreenContext {
    ...
    public static final ScreenContext DEFAULT_CONTEXT =
            new ScreenContext(
                    ColorAttribute.COLORS[0], ColorAttribute.COLORS[8], (byte) 0, false, false);
    ...
    public ScreenContext withHighlight(byte highlight) {
        return new ScreenContext(
                foregroundColor, backgroundColor, highlight, highIntensity, isGraphic);
    }
